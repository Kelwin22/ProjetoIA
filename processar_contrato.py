...
from pinecone_utils import inicializar_pinecone, gerar_embedding
...
# Verifica se as chaves do Pinecone estão configuradas
...
# A função 'gerar_embedding' foi movida para 'pinecone_utils.py' e é importada de lá.
# Não há mais necessidade de defini-la ou configurar OPENAI_API_KEY aqui.
...
def processar_contrato(caminho_pdf):
    ...
    try:
        ...
        for i, doc in enumerate(documentos):
            ...
            # Gera o embedding usando a função importada de pinecone_utils.py
